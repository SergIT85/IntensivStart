...
class FeedFragment : Fragment(R.layout.feed_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val hashMapOllMovie = Single.zip(nawPlaing, getUpcomings, getMoviePopulars, Function3<
            ...
            hashMapOf(MovieEminClass.NOWPLAYING.toString() to t1.results,
        ...
        compositeDisposable.add(hashMapOllMovie
            ...
            .subscribe({ movies ->
                ...
                val listNawPlaing = createMainCardContainer(movies.getValue(MovieEminClass.NOWPLAYING.toString()), R.string.recommended)
